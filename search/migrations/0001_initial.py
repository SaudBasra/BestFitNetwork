    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credential_number', models.CharField(help_text='Full format: 12345-AGC-1', max_length=100, unique=True)),
                ...
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('pending', 'Pending Approval'), ('rejected', 'Rejected'), ('draft', 'Draft')], default='pending', max_length=20)),
                ('image', models.ImageField(blank=True, help_text='Facility main image', null=True, upload_to='facilities/%Y/%m/')),
                ('submission_type', models.CharField(choices=[('admin', 'Admin Entry'), ('self_register', 'Self Registration'), ('bulk_import', 'Bulk Import')], default='admin', max_length=20)),
                ...
                ('submitted_by', models.ForeignKey(blank=True, help_text='Who submitted this facility', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='search.facility')),
            ],
            options={
                'ordering': ['-timestamp'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facility', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='search.facility')),
            ],
        ),
        migrations.AddIndex(
            model_name='facility',
        ...
        migrations.AddIndex(
            model_name='facility',
            index=models.Index(fields=['credential_number'], name='search_faci_credent_5c987d_idx'),
        ),
    ]
